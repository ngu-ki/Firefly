...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/d0.avif",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/g1.avif",
			"assets/images/MobileWallpaper/g2.avif",
		],
		// 背景视频播放地址
			...
			links: [
				{
					...
					url: "https://github.com/ngu-ki/Firefly",
					showName: true,
				},
				{
					name: "Email",
					icon: "fa7-solid:envelope",
					url: "mailto:nguki@nguki.com",
				},
				{
					name: "Sponsor",
					icon: "material-symbols:favorite",
					url: "https://nguki.com/sponsor/",
				},
				{
					name: "RSS",
					icon: "fa7-solid:rss",
